...
INSERT INTO drug (name, description, minDose, maxDose, measure) values ('Buprenorphine','In the substitution therapy of opioid-dependent mostly heroin-dependent patients with buprenorphine, it should be noted that the switch to buprenorphine - especially if there are still significant amounts of other opioids in the body and buprenorphine is given in too low doses - can lead to increased withdrawal symptoms due to its partially antagonistic character.', 0.1, 1.4, 'DOSE_DOUBLE')
INSERT INTO drug (name, description, minDose, maxDose, measure) values ('Ritalin','Methylphenidate is a drug from the group of phenylethylamines. It has a stimulating effect and is now mainly used for the treatment of attention deficit/hyperactivity disorder (ADHD) and less frequently for narcolepsy', 2.5, 3.5,'DOSE_HALVES')
INSERT INTO drug (name, description, minDose, maxDose, measure) values ('Imipramine','Imipramine affects numerous neurotransmitter systems known to be involved in the etiology of depression, anxiety, attention-deficit hyperactivity disorder (ADHD), enuresis and numerous other mental and physical conditions. Imipramine is similar in structure to some muscle relaxants, and has a significant analgesic effect and, thus, is very useful in some pain conditions.', 0.9, 2.1, 'DOSE_DOUBLE')
INSERT INTO drug (name, description, minDose, maxDose, measure) values ('Cipramil','Citalopram is an antidepressant drug of the selective serotonin reuptake inhibitor (SSRI) class. It has U.S. Food and Drug Administration approval to treat major depression, which it received in 1998, and is prescribed off-label for other conditions.', 0.6, 2.0, 'DOSE_DOUBLE')
INSERT INTO drug (name, description, minDose, maxDose, measure) values ('Fluctin','Fluoxetine, also known by trade names Prozac and Sarafem, among others, is an antidepressant of the selective serotonin reuptake inhibitor (SSRI) class. It is used for the treatment of major depressive disorder, obsessive–compulsive disorder (OCD), bulimia nervosa, panic disorder and premenstrual dysphoric disorder. It may decrease the risk of suicide in those over the age of 65. It has also been used to treat premature ejaculation', 0.2, 1.75, 'DOSE_DOUBLE')
INSERT INTO drug (name, description, minDose, maxDose, measure) values ('Seroxat','Paroxetine, also known by trade names including Paxil and Seroxat among others, is an antidepressant of the selective serotonin reuptake inhibitor (SSRI) class. It is used to treat major depressive disorder, obsessive-compulsive disorder, social anxiety disorder, panic disorder, posttraumatic stress disorder, generalized anxiety disorder and premenstrual dysphoric disorder. It has also been used in the treatment of hot flashes and night sweats associated with menopause.', 0.6, 0.9, 'DOSE_DOUBLE')
